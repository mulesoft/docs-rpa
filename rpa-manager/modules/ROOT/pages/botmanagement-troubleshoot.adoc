...
As you can see in the *Schedule Chart*, the service times and the downtimes are converted to the bot's timezone. They are observed simultaneously across all time zones. The schedule is interpreted to be in the bot's time zone. It is observed at different times across all time zones.
