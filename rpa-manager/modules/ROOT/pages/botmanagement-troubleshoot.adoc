...
. In the table, click *Execution timetable* (image:executiontimetable-icon.png["",1.5%,1.5%]) in the row of the bot you want to check.
...
. Click *Configure Execution Timetable* (image:configure-icon.png["",1.5%,1.5%]) to change the time interval of the table and to select the shown configurations.
. Click *OK*.
...
. Click *Bot Message Log* (image:botmessagelog-icon.png["",1.5%,1.5%]) in the table row of the bot you want to read messages from.
...
. Click *Download Logfiles* (image:download-icon.png["",1.5%,1.5%]) in the row of the bot you want to read the log files from.
...
. Open the *Bots* view of the *Bot Management* module.
. On the panel of the bot to debug, click *Turn on debug logging* (image:debug-icon.png["",1.5%,1.5%]).
