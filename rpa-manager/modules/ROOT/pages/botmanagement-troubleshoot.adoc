...
If a bot is running properly, but a process execution fails, and you need help to detect the cause, turn on debug logging. 
...
If a bot is running properly, but a process execution fails, and you need help to detect the cause, turn on debug logging for at least the time span of the next process run.
