...
The bot log messages contain detailed information about a process run. Each bot activity is listed along with information about the run result. Bot messages contained in activities are displayed under *Additional Customer Info*.

To view the bot log messages:

. Open the *Process Run Statistics* view in the *Bot Management* or, from within a project in test or production phase in the *Process Automation* module, click on a run result number in the *Run Results* panel.
. Click the *Bot Message Log* icon image:botmessagelog-icon.png[list symbol,1.5%,1.5%] in the table row of the bot whose messages you want to read.

The window *Bot Log Messages* opens. 

Bot messages can be concatenated and truncated. To view the complete bot log, download the log files.
...
. Click the *Download Logfiles* icon image:download-icon.png[disk-with-downwards-arrow symbol,1.5%,1.5%]  in the table row of the bot whose log files you want to read.
