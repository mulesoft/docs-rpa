...
Transition the project to the production phase to publish an invocable run configuration to Anypoint Exchange.

Projects that have already been used productively can no longer be deleted. Deleted invocable run configurations are not deleted in Anypoint Exchange. Edited and updated invocable run configurations are published as new versions in  Anypoint Exchange.
...
The invocable run configuration is published to Anypoint Exchange upon saving.
