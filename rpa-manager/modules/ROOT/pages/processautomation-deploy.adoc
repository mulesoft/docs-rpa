...
Sometimes it's necessary to start a process manually when something happens that can only be evaluated by a human. For example, the goods inwards inspection process can only be started once the banana delivery ship reaches the pier wall. For this purpose, use the *Run Now* option.
...
** *Intervals*
+
Enter the interval to repeat the process.
+
** *Cron expression*
+ 
//To do: add link to Cron partial
Enter a Cron expression to repeat the process.
+
** *Calendar Scheduling*
+
