...
* To create a project, you must be xref:usermanagement-manage.adoc#designate-a-user-as-project-manager[designated as project manager].
* To copy a project, you must be xref:usermanagement-manage.adoc#designate-a-user-as-project-manager[designated as project manager] and xref:usermanagement-manage.adoc#assign-users-rpa-builder-access[assigned access to RPA Builder].
...
. Open the *Project Management* view of the *Process Automation* module.
. Click on the name of the category of the project you want to copy.
...
Only after the copy process is completed, the following actions are possible:
...
. In the *<category name>* view, click the *Edit* icon image:edit-icon.png[pen-to-square symbol,1.5%,1.5%] on the panel of the project to edit.
. Check and edit the form *Copy process*:
+
For an explanation of the properties, see <<form-createprocess, *Create process*>>.
. Click *Save*.
...
. Open the *Project Management* view of the *Process Automation* module.
. Click on the name of the category of the project.
. In the *<category name>* view, click the *Remove* icon image:delete-icon.png[trash symbol,1.5%,1.5%] on the panel of the project to remove.
. Confirm the prompt.
...
. Open the *Project Management* view of the *Process Automation* module.
. Click on the name of the category of the project.
. In the *<category name>* view, click the *Finance Analysis* icon image:financeanalysis-icon.png[ symbol,1.5%,1.5%] on the panel of the project you want to analyze.
