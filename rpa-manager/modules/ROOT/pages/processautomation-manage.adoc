...
* When the tests are successful, transition the automation to the Production phase.
+
After the project is deployed to an RPA Bot for processing in the production phase, you can no longer delete it.
