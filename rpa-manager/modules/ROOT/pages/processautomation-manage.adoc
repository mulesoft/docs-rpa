...
+
The properties are explained in the topic <<form-createprocess, *Create process*>>.
. Click *Save*.
...
. Open the *Project Management* view of the *Process Automation* module.
. Click on the name of the category of the project.
. In the *<category name>* view, click the *Open process board* icon image:processboard-icon.png[column symbol,1.5%,1.5%] to open the process board.
