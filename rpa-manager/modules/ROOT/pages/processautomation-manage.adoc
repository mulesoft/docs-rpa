...
The project manager can copy or edit the project using the same form.
...
// Same form as *Edit process*  and *Copy process*, is linked there
. [[form-create-edit-copy-process]] Complete the form *Create process*:
+
...
. Complete the form <<form-create-edit-copy-process,*Copy process*>>.
. Click *Save*.
...
. Complete the form *Edit process*.
. Click *Save*.
