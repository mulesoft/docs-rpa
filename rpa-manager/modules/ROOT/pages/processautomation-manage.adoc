...
. Transfer the project to the *Build* phase.
. Open it in the xref:rpa-builder::index.adoc[RPA Builder].

The project then receives its own identification values. The copied project can only transition to the *Test* phase after it is uploaded from the RPA Builder to the RPA Manager.
