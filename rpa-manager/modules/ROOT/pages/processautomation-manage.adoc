...
To automate a process already evaluated with a third-party tool, a project manager can alternativelely create an automation project directly in the following RPA Manager views:
...
+
Already implemented activities don’t lose their implementation if you don’t delete them. 
...
* Transfer the automation back to Build phase to change the implementation.
+
