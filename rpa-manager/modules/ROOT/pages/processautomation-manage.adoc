...
The *Process Management* view shows the categories for organizing the projects.
...
// team permissions included in form
[[process-team-permissions]]
+
...
. Click the *Open process board* icon image:processboard-icon.png[column symbol,1.5%,1.5%] to open the process board.
