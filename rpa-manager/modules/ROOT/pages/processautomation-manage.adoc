...
Once it's ready, transition the project to its next lifecycle phase. You can always transition back to change the automation design or implementation.

In the *Design* phase, you can do the following:
...
* Transfer the automation containing the new or changed models to the Build Phase.

In the *Build* phase, in RPA Builder, you can do the following:
...
+
There is always only one version of a process in the repository in RPA Manager. There might be another local version in RPA Builder. If you accidentally deleted an already implemented Activity, you might still be able to find it in RPA Builder - as long as you do not overwrite the model by downloading.
* Transfer the automation back to the Design phase.
+
Already implemented activities retain their implementation unless you delete them.
* Transfer the automation on to the Test phase.

In the *Test* phase, you can do the following:

* Test the implemented process model in different configurations. 
* Transfer the automation back to the build phase to change the implementation.
+
You can reuse or edit the test run configurations when you transfer the automation to the Test phase again. 
* When the tests are successful, transfer the automation to the Production phase.
+
If the project has been transferred at least once to the production phase and deployed to an RPA Bot for processing, it can no longer be deleted.

In the *Production* phase, you can do the following. 
...
* Transfer the automation back to the Test phase.
+
You can reuse or edit the production run configurations when you transfer the automation to the Production phase again. 

=== Transition to the Next Phase

Once an automation project is ready, transfer it to the next phase. All elements you configured are saved for when you come back.
...
If you need to rework an automation project, transfer it to a previous phase. All elements you configured are saved for when you come back.
