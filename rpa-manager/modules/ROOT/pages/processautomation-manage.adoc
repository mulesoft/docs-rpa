...
. In the *<category name>* view, click the *Edit* icon image:edit-icon.png[pen-to-paper symbol,1.5%,1.5%] on the panel of the project to edit.
. Check and edit the form *Copy process*:
+
For an explanation of the properties, see <<form-createprocess, *Create process*>>.
. Click *Save*.
...
* *Effort*:
+
Time the task approximately takes.
. Click Save.
