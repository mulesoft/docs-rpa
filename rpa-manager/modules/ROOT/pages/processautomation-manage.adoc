...
+
You can't delete automations after they have been in the Production phase.
...
* If you use activities from the Activity Library, you can xref:processoperations-upcomingprocesschanges.adoc[change the deployed version].
