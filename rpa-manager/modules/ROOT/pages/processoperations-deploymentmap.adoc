...
The actions *Start*, *Deploy*, *Manual Execution*, *Pause*, *Continue*, and *Revoke process* refer to a single configuration. The action does not change identical configurations that are deployed to a different bot or different configurations that are deployed to the same bot.
