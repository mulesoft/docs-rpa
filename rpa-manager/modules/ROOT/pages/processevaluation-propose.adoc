...
+
Learn how to xref:processautomation-prepare.adoc#manage-categories[manage categories].
...
+
A category describes the environment of a process in a few keywords. You can assign categories that have been created previously in the *Process Management* view of the *Process Automation* module.
* *Qualifiers/Benefits*:
+
...
* xref:processautomation-prepare.adoc#create-categories[Create Process Categories]
