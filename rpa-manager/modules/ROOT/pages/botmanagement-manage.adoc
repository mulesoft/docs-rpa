...
Update your bots to the latest version to get the newest features, bugfixes, and security enhancements. The bot finishes all processes before updating, and resumes them afterwards to avoid data loss.
...
* The bot is version 1.5 or later.
