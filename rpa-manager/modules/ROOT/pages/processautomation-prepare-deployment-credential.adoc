...
+
To access MuleSoft Intelligent Document Processing (IDP) with RPA Builder xref:rpa-builder::toolbox-mulesoft-idp.adoc[MuleSoft IDP] action steps.
...
* *OAuth Credentials*
+
To access the Microsoft Outlook and Gmail email applications with the RPA Builder xref:rpa-builder::toolbox-mail-operations-mail-session-oauth.adoc[Mail Session (OAuth)] action steps.
...
|===
* If you have access to an Amazon Web Services (AWS) account and want to create AWS credentials for RPA Builder xref:rpa-builder::toolbox-aws-document-processing.adoc[Document Processing with AWS] action steps, https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html[configure the basic settings for the AWS CLI^].
* If you have access to a Microsoft Azure account and want to create OAuth credentials for RPA Builder xref:rpa-builder::toolbox-mail-operations-mail-session-oauth.adoc[Mail Session (OAuth)] action steps, follow these instructions:
+
. https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app[Create an application for Outlook.^]
...
+
If you have access to the Google Cloud console, follow the instructions in https://developers.google.com/workspace/guides/create-credentials#create_credentials_for_a_service_account[Create credentials for a service account^] to obtain credentials for your Google Cloud service account.
* If you want to use RPA Builder to xref:rpa-builder::toolbox-variable-handling-credentials-for-oauth.adoc#generate-oauth-token[generate a refresh token for your OAuth credentials], ask an administrator to assign you the `Builder Usage` privilege.
...
+
For more information about how to create this Azure application for Outlook, see https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app[Quickstart: Register an application with the Microsoft identity platform^].
*** *Client Secret*
+
...
+
Learn how to xref:rpa-builder::toolbox-variable-handling-credentials-for-oauth.adoc#generate-oauth-token[generate an OAuth refresh token with RPA Builder].
** *User Account Credentials*
+
