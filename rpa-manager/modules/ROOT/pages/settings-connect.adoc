...
. Open the *User API Keys* view of the *User Management* module.
. Click *Edit* (image:edit-icon.png["",1.5%,1.5%]) on the panel of the user API key to edit.
...
. Open the *User API Keys* view of the *User Management* module.
. Click *Remove* (image:delete-icon.png["",1.5%,1.5%]) on the panel of the user API key to remove.
. Confirm the removal.
