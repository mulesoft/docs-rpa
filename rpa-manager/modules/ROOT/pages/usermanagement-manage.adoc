...
. Open the *Users* view of the *User Management* module.
. Click *Assign Project* (image:assignproject-icon.png["",1.5%,1.5%]) in the panel of the user whose project assignments you want to change.
...
. Open the *Users* view of the *User Management* module.
. Click *Reset Password* (image:resetpassword-icon.png["",1.5%,1.5%]) in the panel of the user to edit.
...
. Open the *Users* view of the *User Management* module.
. Click *Deactivate Two-Factor Authentication* (image:userdeactivate2fa-icon.png["",1.5%,1.5%]) in the panel of the user whose 2FA want to deactivate.
