...
If 2FA is activated for a user of the RPA Manager, the user enters their personal password on login followed by a time-based one-time password (TOTP) to verify themselves. There mustn't be a space between password and TOTP.
