...
Change permissions for assigned projects to adapt to changed responsibilities. You cannot cannot change permissions for the project manager who always has permissions for every phase.

. In the view *Assign Process*, for each process, select the checkboxes to permit the phases to the user.
. Click *Save*.

Learn how to xref:processautomation-manage.adoc#process-team-permissions[assign advanced permissions].
...
. In the table *Process List*, in the row of the added process, select the checkboxes of all phases you want to permit to the user.
. Click *Save*.

Remove processes from the user
