...
If you forgot your password or if your one-time password has expired, reset it by clicking the link on the RPA Manager login page. You need to know your user name for resetting your password.

. Navigate to the RPA Manager login screen.
. Click the *Forgot your credentials?* link.
