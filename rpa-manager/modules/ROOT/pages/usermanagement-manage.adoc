...
Change permissions for assigned projects to reflect changed user responsibilities:
...
+
The properties are explained in the topic <<form-create-user, *Create a new User*>>.
. Click *Save*.
