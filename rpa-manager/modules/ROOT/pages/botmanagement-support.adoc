...
You can assign multiple service times to a bot. If you do not assign any service times to a bot, it works 24/7.
...
The names of the service times do not have to be unique. To avoid misunderstandings of the interpretation of the effective schedule runtimes, include the time zone in the name of the service time.

For example, `Regular working hours - 9 AM - 5 PM - Mystical University - Buenos Aires (ART (UTC -3))` and  `Low resource usage time - 5 PM - 9AM - Mystical University - Berlin (CET (UTC +1))`.
