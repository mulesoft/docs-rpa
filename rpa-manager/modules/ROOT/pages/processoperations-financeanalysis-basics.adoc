...
In our example, in May 2020, an initial investment of 120,000&nbsp;&euro; was made to buy the MuleSoft RPA solution and its environment. The depreciation period defined was 12&nbsp;months. This resulted in a monthly depreciation amount of 10,000&nbsp;&euro; for the next 12 months.
...
If the forecast proves right, the savings grow with each month.
