...
+
If you want to use RPA Builder to generate a refresh token for your OAuth credentials, you must have RPA Builder access assigned.
+
...
** *OAuth Credentials*
+
The credential is used for accessing the Microsoft Outlook email application via Microsoft Azure.
+
*** *OAuth Host*:
+
...
*** *Username*
+
Email address for accessing the Azure account.
*** *Refresh Token*
+
