...
. Open the *Process Applications* view of the *Process Automation* module.
. Click *Deactivate* (image:deactivate-icon.png["",1.5%,1.5%]) on the panel of the application to deactivate.
...
. Open the *Process Applications* view of the *Process Automation* module.
. Click *Activate* (image:activate-icon.png["",1.5%,1.5%]) on the panel of the application to activate.
