...
You can also enable or disable the automatic creation of Activities on application changes.
...
//Commenting since it shows version 5.0 and new release is 6.0
