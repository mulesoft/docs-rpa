...
The Home section contains the main controls of the recorder. If the recorder is started from the server, the existing BPMN of the process also shows here.
...
|image:start-recording-icon.png[Start Recording icon, 25%, 25%] |Start Recording | Starts a new recording session. |`F8`
|image:finish-recording-icon.png[Start Recording icon, 25%, 25%] | Finish Recording Session. | Finishes the current recording session, and triggers the generation of xref:documents.adoc[Documents] | --
|image:take-screenshot-icon.png[Take Screenshot icon, 25%, 25%] | Take Screenshot | Opens the <<Define Screenshot>> dialog.  | `F9`
|image:add-variable-icon.png[Add Variable icon, 25%, 25%]  | Add Variable | Opens the <<Add Variable>> dialog. | `F10`
|image:add-comment-icon.png[Add Comment icon, 25%, 25%] | Add Comment | Opens the <<Add Comment>> dialog. | `F11`
|image:add-activity-icon.png[Add Activity icon, 25%, 25%] | Add Activity | Opens the <<Add Activity>> dialog. | `F12`
|===
...
Before you take a screenshot manually, the screen automatically freezes. You can select a method for taking for taking manual screenshots:
...
[NOTE]
You must pause the recording to add a variable. If you open the Add Variable window while the recording is running, it pauses automatically.
...
[NOTE]
You must pause the recording to add a comment. If you open the Add Comment Window while the recording is running, it pauses automatically.
...
To continue recording, add an RPA Bot Task.

You ca also enable or disable the automatic creation of Activities on application changes.
...
image:about-screen.png[About Screen]
