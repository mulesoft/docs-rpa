...
|image:start-recording-icon.png[Start Recording icon] |Start Recording | Starts a new recording session. |`F8`
|image:finish-recording-icon.png[Start Recording icon] | Finish Recording Session. | Finishes the current recording session, and triggers the generation of <<Documents>> | --
|image:take-screenshot-icon.png[Take Screenshot icon] | Take Screenshot | Opens the <<Define Screenshot>> dialog.  | `F9`
|image:add-variable-icon.png[Add Variable icon]  | Add Variable | Opens the <<Add Variable>> dialog. | `F10`
|image:add-comment-icon.png[Add Comment icon] | Add Comment | Opens the <<Add Comment>> dialog. | `F11`
|image:add-activity-icon.png[Add Activity icon] | Add Activity | Opens the <<Add Activity>> dialog. | `F12`
|===
