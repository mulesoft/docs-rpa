...
Select a process and click on the *Edit, Merge and Upload Recordings* button (image:edit-process-button.png[Edit, Merge and Upload Recordings button, 0.01%, 0.01%]) to open the Process Recording Editor.
