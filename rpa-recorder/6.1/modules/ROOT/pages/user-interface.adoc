...
When you hover the cursor over a web element, the browser highlights it with a blue background. After highlighting an element, its XPath and available attributes show on the Attribute Selection panel.

To record the mouse hover event, press `F2`.
