...
If you don't want to use the saved attributes for a given web element, click the image:default-icon.png[Default button] to revert back to the default extracted XPath for that web element.
