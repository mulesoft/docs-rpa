...
Use the Web Recording Browser to record web elements. It behaves like a normal browser and enables you to select additional elements of a website and determine their XPath.
You can also save your attribute selection of a web element to reuse it when recording the same web elements on a website.
