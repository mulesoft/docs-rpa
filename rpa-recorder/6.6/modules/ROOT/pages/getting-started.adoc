...
To start RPA Recorder, click *Record* from the xref:rpa-builder::workbench-toolbar-overview.adoc[Workbench Toolbar] or double-click the name of an App Session in the Activity Workflow. When you start RPA Recorder from RPA Builder:
