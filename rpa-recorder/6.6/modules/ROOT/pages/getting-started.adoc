...
* xref:rpa-builder::workbench-toolbar-overview.adoc[Use the *Record* option in RPA Builder to record a workflow]
* xref:rpa-builder::toolbox-app-automation-app-session.adoc[Record an App Session in RPA Builder]
* xref:rpa-builder::toolbox-web-automation.adoc[Record a Web Session in RPA Builder]
