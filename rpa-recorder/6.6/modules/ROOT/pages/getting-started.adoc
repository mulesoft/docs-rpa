...
* You can update to the latest RPA Recorder version by clicking *Update Available* on the RPA Recorder home page. The option shows automatically when you log in if a later version is available to download.
