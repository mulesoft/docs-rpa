...
. Click Record BPMN (image:record-bpmn-icon.png["", 2%, 2%]) in RPA Manage to open RPA Recorder.
...
To log out of RPA Recorder, click the *Logout* icon (image:logout-icon.png["", 2%, 2%]).
