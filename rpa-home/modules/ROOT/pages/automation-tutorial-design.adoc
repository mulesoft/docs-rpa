...
+
This options creates the `generatedWebSession1` Action Parameter, which enables you to continue using the same web session in subsequent Web tasks. You can also reference this parameter when you create new Action Steps during the build phase in RPA Builder. 
.. Click *Add*
