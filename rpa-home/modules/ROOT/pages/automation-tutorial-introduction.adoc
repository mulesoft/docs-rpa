...
During this tutorial, you create a simple automation project that accesses the MuleSoft website, subscribes to the newsletter, and then user optical character recognition(OCR) to confirm the process.
