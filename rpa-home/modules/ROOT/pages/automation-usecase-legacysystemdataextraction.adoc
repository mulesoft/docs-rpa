...
* xref:automation-usecase-legacysystemdataextraction-extractfromsceen[Implement the tracking number extraction activity]
* ...Gateway
* ...UserTask

## Upload Your Process to RPA Manager
