...
. In Composer, open the flow you created in xref:automation-tutorial-composer.adoc#step-8-1[Step 8.1: Create a New Composer Flow] for editing and click *Test*. 
