...
A measurement unit that reflects any action that a Composer Connector executes, including, but not limited to: read, create, update, and delete actions. See the https://www.mulesoft.com/prod-subscription-plans[MuleSoft Product Subscription Plans^] for additional details.
...
A measurement unit used to calculate Automation Credits usage based on outbound REST API Calls that are made from an RPA Process. See the https://www.mulesoft.com/prod-subscription-plans[MuleSoft Product Subscription Plans^] for additional details.

=== RPA Bot Minute

A measurement unit used to calculate Automation Credits usage based on RPA executions. See the https://www.mulesoft.com/prod-subscription-plans[MuleSoft Product Subscription Plans^] for additional details.
