= RPA Builder 6.7.17 Release Notes
...
This version is internal only. All features and fixed issues for this version are implemented in version xref:rpa-home::release-notes/rpa-builder-6.7.18-release-notes.adoc[6.7.18].
