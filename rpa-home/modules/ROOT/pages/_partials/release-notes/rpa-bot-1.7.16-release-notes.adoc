...
This version is deprecated. All of the features and fixed issues for this version are in version xref:rpa-home::release-notes/rpa-bot-1.7.18-release-notes.adoc[1.7.18].
