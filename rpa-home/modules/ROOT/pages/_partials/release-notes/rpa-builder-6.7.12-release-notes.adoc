= RPA Builder 6.7.12 Release Notes
...
* The Tomcat dependency is upgraded to version 9.0.106 to address reported security vulnerabilities.
...
|===
| Issue Resolution | ID
| RPA Builder now accepts both Unix and Windows ZIP file formats for analysis packages, preventing loading errors when packages use different internal path separators. | W-19076042
| The Tomcat dependency is upgraded to version 9.0.106 to address reported security vulnerabilities | W-18849660
| The OAuth login dialog no longer throws assembly loading errors when authenticating. | W-19083573
| The CefSharp.Common library is upgraded to address reported security vulnerabilities. | W-18748769
