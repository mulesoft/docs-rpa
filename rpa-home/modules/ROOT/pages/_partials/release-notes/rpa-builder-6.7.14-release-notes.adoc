= RPA Builder 6.7.14 Release Notes
...
* The Tomcat dependency is upgraded to version 9.0.108 to address reported security vulnerabilities.
...
|===
| Issue Resolution | ID
| The Read mail action no longer fails when saving email attachments with long filenames that exceed Windows file path limitations. | W-19615020
