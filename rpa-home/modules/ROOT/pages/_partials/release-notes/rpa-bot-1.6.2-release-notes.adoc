...
|===
| Issue Resolution | ID
|The custom message created from the *Write Bot Message* action step and now displays the full 2,000 characters and no longer truncates the message after 1,000 characters.| W-15252227 
