...
|The Bot Configurator *Test Connection* button no longer ignores proxy settings. | W-13854428
...
|RPA Bot now detects Windows 19 and 22 when testing the settings in the Session Settings panel. | W-13873385
|===
