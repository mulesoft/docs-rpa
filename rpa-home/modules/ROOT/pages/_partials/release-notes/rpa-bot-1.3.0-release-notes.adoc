...
* A message now shows on single session systems, such as Windows 10 and 11, that the test may fail if no further sessions are available.
...
* AAdded an RPA Bot config file to the Bot Logfile package.
...
|The *Password* field is now filled following a new RPA Bot installation. | W-13704551
