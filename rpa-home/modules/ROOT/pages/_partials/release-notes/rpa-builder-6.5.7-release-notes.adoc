= RPA Builder 6.5.7 Release Notes
...
This version is internal only. All of the features and fixed issues for this version are implemented in version xref:rpa-home::release-notes/rpa-builder-6.5.8-release-notes.adoc[6.5.8].
