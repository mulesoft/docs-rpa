...
|===
| Issue Resolution | ID
| RPA Bot no longer terminates processes when screenshot uploads exceed 30 seconds, ensuring the connection to the Secure Session remains stable during longer upload durations. | W-21523306
|===
