= RPA Builder 6.5.1 Release Notes
...
This version is internal only. All of the features and fixed issues for this version are in version xref:rpa-home::release-notes/rpa-builder-6.5.2-release-notes.adoc[6.5.2].
