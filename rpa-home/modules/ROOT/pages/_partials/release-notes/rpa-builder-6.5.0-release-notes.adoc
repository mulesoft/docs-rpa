...
* The new Signature Detection with AWS action step enables you to extract one or more signatures from a document. 
* The new Check Folder action step enables you to check the existence of a folder in the specified path. 
* The new Create Folder action step enables you to create a new folder in the specified path. 
* The new Copy Folder action step enables you to copy a folder, including all subfolders and files, to the specified path. 
* The new Delete Folder action step enables you to delete a folder, and all its contents, in the specified path. 
* The new Rename Folder action step enables you to rename a folder in the specified path. 
* The new Session Based Variables action step enables you to share variables accross all workflows that run inside the same session. 
