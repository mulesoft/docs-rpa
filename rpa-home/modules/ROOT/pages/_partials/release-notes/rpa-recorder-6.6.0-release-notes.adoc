...
* When starting RPA Recorder from RPA Manager, you can now install the latest RPA Recorder version from the RPA Recorder home page. An *Update Available* button shows on the home page when a new version is available.
...
|===
| Issue Resolution | ID
|Audio and video no longer continues to play after closing your browser when recording a Web Task. |W-14965350
...
|HTML escape characters are now encoded in your recording's documentation and displayed in plain text format. |W-15099313
...
|Highlighting and recording events now works as expected when recording a Web Task on salesforce.com as well as on subsequent websites you go to after going to salesforce.com. |W-14666842
|===
