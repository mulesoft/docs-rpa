...
| The JSON Query action step no longer changes the Date format. 
[WARNING]
Because this fix changes the output of the JSON Query action step, you might need to adapt existing processes that use this action step to read the Date values in the expected format. 
| W-13027264
