...
* Added property in *Excel Controlled Loop* and *Read from Excel file* action steps to avoid recalculation of formulas in date cells.
...
|===
| Issue Resolution | ID
| The WorkflowValidator no longer freezes when preparing to validate properties with big input. | W-12613901
...
| The JSON Query action step no longer changes the Date format. | W-13027264
