= RPA Builder 6.7.24 Release Notes
...
* The *Tomcat* dependency is upgraded to version 9.0.120 to address reported security vulnerabilities.
* The *Camunda* engine is upgraded to version 7.23.00.
...
|===
| Issue Resolution | ID
| The transitive `commons-fileupload` dependency is updated to address reported security vulnerabilities. | W-23610276
|===
