...
* RPA Bot updates can now be started from RPA Manager so that you can easily update to the latest version without to click through the setup process manually.
