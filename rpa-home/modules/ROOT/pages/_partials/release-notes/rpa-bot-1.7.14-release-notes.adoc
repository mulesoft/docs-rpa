...
|===
| Issue Resolution | ID
| RPA Bot no longer causes incorrect process execution on the RPA Manager due to network timeout errors. | W-19074454 
| RPA Bot no longer creates invalid analysis packages with incompatible path separators. | W-19074394 
