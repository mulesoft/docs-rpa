= RPA Bot 1.1.0 Release Notes

RPA Bot is a software robot that runs in an on-premise environment and executes the assigned automations.

This version is deprecated. All of the features and fixed issues for this version are in version xref::rpa-home/release-notes/rpa-bot-1.1.6-release-notes.adoc[1.1.6].

xref:rpa-home::release-notes/rpa-bot-1.1.6-release-notes.adoc[1.1.6].
