...
// Future privileges
//
// == Privileges of the *RPA Public REST API* category
//
// You will require the special privileges listed below to use the *RPA Public REST API*.
//
// The individual Privileges you'll need to call can be found in the  *RPA Public REST API* documentation.
//
// [cols="1,2"]
// |===
// |*Privilege* |*Permitted Action*
...
// |Administration of Process Applications using the *RPA Public REST API*
//
// |*REST API Global Variables/Credential Pool*
// |Administration of Global Variables and the Credential Pool using the *RPA Public REST API*
//
// |*REST API Processes*
// |Administration of Processes using the *RPA Public REST API*
//
// |*REST API Process Board*
// |Administration of Process Boards using the *RPA Public REST API*
//
// |*REST API Production Configurations*
// |Administration of Process Configurations using the *RPA Public REST API*
//
// |*REST API Robots*
// |Administration of *X1 Bots* using the *RPA Public REST API*
//
// |*REST API Test Configurations*
// |Administration of Test Configurations using the *RPA Public REST API*
//
// |===
