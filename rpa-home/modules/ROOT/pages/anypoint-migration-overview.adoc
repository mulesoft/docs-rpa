...
* RPA Manager supports deleting users that have assigned processes and reassigning those processes to other users or teams. 
...
+
See xref:access-management::external-identity.adoc[] for instructions and requisites to configure identity management for your Anypoint Platform organization. 
