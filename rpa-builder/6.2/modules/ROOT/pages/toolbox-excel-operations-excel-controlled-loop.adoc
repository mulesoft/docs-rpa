...
+
Specifies the number of consecutive empty
...
* *End row* 
+
Specifies exactly the row that the sheet is to
be read to.
* *Has a header* 
+
Indicates whether you have selected the option. If you
...
+
Shows the regular expression that the
...
* *Row* 
+
Specifies the row that the Excel sheet is to be read from.
* *Sheet name* 
+
Name of the spreadsheet. In the properties, you can only
