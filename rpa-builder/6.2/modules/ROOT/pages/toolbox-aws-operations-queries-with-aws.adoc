...
include::partial$aws-action-steps-language-support.adoc[tag=languageSupportAdvice]

//Link to list of languages supported by Amazon Textract Queries
include::partial$aws-action-steps-language-support.adoc[tag=supportedLanguagesAmazonTextractQueries]
