...
+
Define command-line parameters for _Google Chrome_. 
+
...
You can specify a user data profile as an argument in the *Additional arguments* field to start the web session using said profile, for example: `--user-data-dir=c:\Users\<userName>\AppData\Local\Google\Chrome\User Data`. 
