...
+
Outputs all characters between the last occurrence of the *Character to trim at* and the end of the string. For example: 
+
*** *Input text (string)* = `MyTESTString`
*** *Character to trim at* = `T`
*** Output = `String`
...
+
Removes all characters between the last occurrence of the *Character to trim at* and the end of the string. For example: 
+
*** *Input text (string)* = `MyTESTString`
*** *Character to trim at* = `T`
*** Output = `MyTES` 
