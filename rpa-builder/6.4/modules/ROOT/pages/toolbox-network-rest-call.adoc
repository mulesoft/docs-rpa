...
** *Timeout*
+
The time in seconds the activity waits. Settings this value to `0` forces the activity to wait indeterminately. 
+
Note that you must disable *Use general timeout* for the custom timeout to work. 

** *Use general timeout*
+
Select this option to use the default timeout: `30` seconds.  
