...
+
Specify path information for all action steps of the type File Operations in Settings. To access the Settings configuration panel, click (image:settings-icon.png["", 2%, 2%] *Settings*) in the Workflow Initialization block.
* *Path checking*
+
