= Mail Session (OAuth)
:page-aliases: toolbox-mail-operations-mail-session-outlook-with-oauth.adoc
...
* *Outlook*
** An Azure account
** SMTP AUTH enabled for your Microsoft organization or the specific mailbox when connecting with an Azure environment via SMTP
+
