...
Before you configure this action step, ensure you have: 

* An Azure account, if you are creating an application for Outlook
* A Google account, if you are creating an application for Gmail
