...
+
To confirm if the search returned any results, verify if the *Amount found matches* is higher than zero. The *Success* variable returns (`True`) even when there are no results but the search is successful. 
