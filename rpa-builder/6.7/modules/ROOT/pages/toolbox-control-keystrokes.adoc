...
* *Clear* Deletes all keystrokes within the action step
...
_Start_ is clicked
* *List of keystrokes* All the keystrokes defined for this action step
are listed here
* *Use window text* Defines if, in addition to the window title, window
text should also be used to identify the window that the keystrokes
should be sent to
...
_Keystroke_ action step by using the corresponding drop-down menu.
