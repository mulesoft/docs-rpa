...
. In the context pad, click *Add to Activity Library* (image:add-to-activity-library-icon.png["", 2%, 2%])
+
...
. In the context pad, click *Import Workflow from Activity Library* (image:import-workflow-from-activity-library-icon.png["", 2%, 2%])
...
. On the context pad, click *Show Activity Log* (image:activity-library-explorer-toolbar-show-log.png["", 2%, 2%]). 
