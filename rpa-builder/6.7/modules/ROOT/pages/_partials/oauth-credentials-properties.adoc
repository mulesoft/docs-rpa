...
+
For more information on how to create an Azure application for Outlook, visit https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app[Quickstart: Register an application with the Microsoft identity platform^].
** *Client Secret*
+
