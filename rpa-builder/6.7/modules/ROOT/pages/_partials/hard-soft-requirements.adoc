...
* Java Runtime Environment 11 (JRE, 64-bit version)
* Adoptium 11 (JRE, 64-bit version)
...
+
The operating system can block the execution of certain files. Make sure that all executable (`.exe`) files inside the RPA Builder home directory and its subfolders are allowed to run. 
...
* From: `C:\Users\<username>\Documents\Mulesoft\Cache` 
* To: `C:\Users\<username>\OneDrive\Documents\Mulesoft\Cache`
...
A user describes this problem in detail in a https://learn.microsoft.com/en-us/answers/questions/5247101/onedrive-remapped-my-folder-structure-please-rever?forum=msoffice-all&referrer=answers[Microsoft Community thread].
a| 
If you use RPA Builder on a computer that has OneDrive, don't let OneDrive back up your Documents folder. 

The https://support.microsoft.com/en-us/office/back-up-your-folders-with-onedrive-d61a7930-a6fb-4b95-b28a-6552e77c3057?culture=en-us&country=us#ID0EDBH=Windows[Microsoft OneDrive documentation] explains how to exempt the Documents folder from the OneDrive backup.
|===
