...
** *Max Runtime*
+
The maximum allowed time for a workflow to run before it stops its execution. By default, this value is set to 2 hours. The minimum allowed value for this field is 10 minutes and the maximum is 1440 minutes (24 hours).
