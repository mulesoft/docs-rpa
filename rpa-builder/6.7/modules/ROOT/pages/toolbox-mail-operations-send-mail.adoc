...
Use the Send Mail action step to send a mail with the SMTP
...
Send Mail doesn't support sending HTML emails and sends the content in *Body* over SMTP as plain text. To send a message body rendered as HTML, use RPA Builder to automate any SMTP CLI tool or any online or local mail client. 
...
characters are available. RPA Builder sends the body as plain text.
