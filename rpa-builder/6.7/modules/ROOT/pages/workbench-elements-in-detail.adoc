...
* (image:record-icon.png["", 2%, 2%]) *Record*
+
...
* *Collapse All*
+
Collapses all levels of the Workflow to the highest level shown in the current view. Use the *Collapse All* (image:minus-icon.png["", 2%, 2%]) button to collapse individual elements.
* *Expand All*
+
