...
To perform a test run of a Workflow in RPA Builder, click *Run Workflow* (image:run-process.png["", 2%, 2%]) on the Workbench toolbar or press _F7_ on your keyboard.
...
. Click the (image:test-script-tray-icon.png["", 2%, 2%]) tray icon.
