...
+
Before you can query the results, you must run the Submit Document to MuleSoft IDP action step to trigger the execution of said document action. 
...
+
Use the returned Execution ID to query the results later using the Retrieve Results from MuleSoft IDP action step. 
