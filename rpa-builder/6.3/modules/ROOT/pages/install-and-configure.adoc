...
== Connect RPA Builder with Anypoint

After opening RPA Builder for the first time, configure the connection with Anypoint Platform:
...
If your organization was not migrated to Anypoint Platform yet, follow these steps to configure the connection with RPA Manager after opening RPA Builder for the first time:
