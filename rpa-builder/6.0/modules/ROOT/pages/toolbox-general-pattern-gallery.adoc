...
properties, other than the link:#CommonProperties[Common Properties].
...
link:#PatternStrip[Pattern Strip] section. The _Pattern Gallery_ also
...
are used can be copied to the clipboard by clicking the *Copy to
clipboard* button. The names of the __Action Step__s that make use of
