...
This is the default path of the _Managed Block_. The _X1 Bot_ will first
...
generierte Beschreibung,width=319,height=79]
...
highlighted and have the focus. The address bar will look like this:
...
generierte Beschreibung,width=391,height=264]
