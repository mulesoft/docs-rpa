...
* *Client ID* The client ID used to authenticate against AWS.
* *Client Secret* The client secret used to authenticate against AWS.
* *Region Endpoint* The AWS region endpoint to connect to.
