...
* [#AS_Coordinate_P_CoordinateAsPoint .anchor]####**Coordinate as
point** (default: 0.0) X and Y coordinates
* [#AS_Coordinate_P_XOffset .anchor]####**X Offset** (default: 0) This
value specifies the X value (horizontal) to be added to the X
coordinate.
* [#AS_Coordinate_P_YOffset .anchor]####**Y Offset** (default: This
value specifies the X value (horizontal) to be added to the X
coordinate.
...
*Modified Coordinate* Coordinate pair calculated at _Workflow_ runtime
from (X-coordinate + X-offset) and (Y-coordinate + Y-offset).
