...
* [#AS_IterateOverFiles_P_DirectoryPath .anchor]####**Directory path**
...
link:#AS_Settings_InvalidCharacters[Path/file name/invalid characters].
...
link:#AS_IterateOverFiles_P_DirectoryPath[*Directory path*]

=== link:\l[*File name*]Outbound Variables
...
absolute path or a path relative to the _Base Path_ using the
...
link:#FileOperation[File Operations].
