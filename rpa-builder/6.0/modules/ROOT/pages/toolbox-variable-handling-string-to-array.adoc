...
[#AS_StringToArray_P_InputString .anchor]####**Input String** (string,
empty with the default setting, must not be empty) String that can be
...
In the wizard, you also have the option of entering the separator via a
pin variable.
...
=== link:\l[*Separator*]Outbound Variables
