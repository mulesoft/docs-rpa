...
…_Decrease Indent_ reduces how far the selected text is positioned from the margin

…_Increase Indent_ moves the selected text further from the margin

//image:media\image10.png[image,width=23,height=26]
_Comment out selected lines_ ignores the selected lines

//image:media\image11.png[image,width=25,height=22]
_Uncomment selected lines_ ensures the selected lines of text are not ignored
