...
* _Error:_ In this case the exit code 120 will be shown. In the _X1
Server_, for example in the Schedule Run Results__,__ this Workflow is
shown as failed (red). In the Workflow Run Results in the _X1 Design
Studio_ it will be noted that this involves a user exit.
...
the _X1 Server_ there will be a warning (yellow) shown for it. As in a
normal case, there will be a check whether timers/checkpoints could not
be measured. The Workflow Run Results in the X1 Design Studio will be
