...
created in Section _Creating the Workflow_,
...
Since we want to measure the initial loading time of the webpage, weleave the _Initial URL_ as it is: _about:blank_.
...
//image:media\image2.png[Ein Bild, das Text enthält. Automatischgenerierte Beschreibung,width=421,height=187]
////
