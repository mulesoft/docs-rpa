...
More information about _Data Sources_ and _Reporting_ can be found in
the _Servicetrace® X1 Server_ manual in the section on _Reporting_ under
the subsection _Widget Types_.
