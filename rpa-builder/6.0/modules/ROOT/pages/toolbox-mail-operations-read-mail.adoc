...
[#AS_ReadMail_P_AttachmentFolderPath .anchor]####**Attachment folder
path** Path to the folder in which the attachments of the e-mails are
saved.

[#AS_ReadMail_P_Body .anchor]####**Body** Text to be contained in the
body of the e-mail.
...
[#AS_ReadMail_P_FolderName .anchor]####**Folder name** Name for the
folder that is specified in the Read Mail Action Step under _Inbox
Folder Name_.
...
[#AS_ReadMail_P_MailInfo .anchor]####**Mail info** The ID of a specific
e-mail that originates from a different Read Mail Action Step and can be
incorporated here as an inbound variable.

[#AS_ReadMail_P_MaxEmailsToRead .anchor]####**Maximum emails to read**
Displays the number of e-mails to be read. You can read up to 99
e-mails.

*Read* Only those e-mails that have already been read are displayed.

[#AS_ReadMail_P_RecipientCc .anchor]####**Recipient (Cc:)** The
recipient address is sought in the Cc.

[#AS_ReadMail_P_RecipientTo .anchor]####**Recipient (To:)** The
recipient address is sought.
...
[#AS_ReadMail_P_Sender .anchor]####**Sender** The entered text is to be
contained in the sender address.
...
[#AS_ReadMail_P_Subject .anchor]####**Subject** Here, the text is sought
only in the subject of the e-mail.

[#AS_ReadMail_P_TextSearch .anchor]####**Text search** This text is
sought in the entire e-mail.
...
generierte Beschreibung,width=273,height=328]
...
generierte Beschreibung,width=270,height=393]
