...
* [#AS_MoveFile_P_DirectoryPath .anchor]####**Directory path** Enter the
...
* [#AS_MoveFile_P_FileName .anchor]####**File Name** Enter the name here
...
link:#AS_MoveFile_P_DirectoryPath[*Directory path*]

link:#AS_MoveFile_P_FileName[*File name*]
...
can create an absolute path or a path relative to the _Base Path_ using
the image:media\image1.png[image,width=175,height=22] and
