...
Using _Break Loop_ only makes sense in combination with a _Managed
Control Block_, because otherwise it would be executed during the first
...
generierte Beschreibung,width=391,height=123]
