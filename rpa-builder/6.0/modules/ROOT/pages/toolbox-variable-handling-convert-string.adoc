...
[#AS_ConvertString_P_ConversionSource .anchor]####**Conversion Source**
The string or variable that is converted

[#AS_ConvertString_P_RegularExpression .anchor]####**Regular
Expression** You may define a regular expression to use only a specific
...
expressions can be found in section
