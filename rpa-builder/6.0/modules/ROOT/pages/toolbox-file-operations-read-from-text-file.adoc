...
after it is read.
* [#AS_ReadFromTextFile_P_DirectoryPath .anchor]####**Directory path**
...
* [#AS_ReadFromTextFile_P_FileName .anchor]####**File name** Enter the
...
link:#AS_ReadFromTextFile_P_DirectoryPath[*Directory path*]

link:#AS_ReadFromTextFile_P_FileName[*File name*]
