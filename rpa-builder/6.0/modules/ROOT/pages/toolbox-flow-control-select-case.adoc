...
section link:#CommonProperties[_Common Properties_]. For reasons of
...
generierte Beschreibung,width=370,height=100]

* *Cases* You can create one or more cases using the
image:media\image2.png[image,width=105,height=29] button depending on
which data type you have selected above. After you have created a case,
you can use the image:media\image3.png[image,width=40,height=24] button
to modify it. Use the image:media\image4.png[image,width=32,height=30]
button to delete a case that was created unintentionally. A step-by-step
guide to configuring _Select Case_ is provided below.
...
in the section on link:#UsingRegularExpression[Using Regular
Expressions].
