...
* [#AS_RenameFile_P_DirectoryPath .anchor]####**Directory path** Enter
...
* [#AS_RenameFile_P_FileName .anchor]####**File Name** Enter the name
here of the file that is to be renamed.
* [#AS_RenameFile_P_NewFileName .anchor]####**New File Name** Here you
enter he new name of the file to be renamed.
