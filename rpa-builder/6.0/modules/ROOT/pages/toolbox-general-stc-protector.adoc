...
detail in Section link:#UsingRegularExpression[Using Regular
Expression].
...
generierte Beschreibung,width=378,height=302]

Now, during execution, when the pop-up window appears, the _STC
Protector_ will automatically send the *_Enter_* keystroke to it and
