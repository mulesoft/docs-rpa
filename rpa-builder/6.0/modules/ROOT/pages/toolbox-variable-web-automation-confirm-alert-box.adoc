...
[#AS_ConfirmAlertBox_P_ActionOnMessagebox .anchor]####**Action on
Messagebox** Decide whether to accept a message box (equivalent to
...
dialogs. Here are some example message boxes from _Internet Explorer_:
