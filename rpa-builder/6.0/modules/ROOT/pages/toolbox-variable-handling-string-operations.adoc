...
generierte Beschreibung,width=333,height=163]
...
generierte Beschreibung,width=290,height=71]
...
to be output as the result. In the example below, the first 4 characters
are displayed as the result.

image:media\image3.png[Ein Bild, das Text enthält. Automatisch
generierte Beschreibung,width=305,height=56]
...
beginning.image:media\image4.png[image,width=307,height=57]
