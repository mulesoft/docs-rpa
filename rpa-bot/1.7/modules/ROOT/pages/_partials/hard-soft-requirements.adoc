...
** https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/overview[Microsoft Remote Desktop Services]
...
RPA Bot requires a stable internet connection to poll tasks from RPA Manager. During downtime of the service or of the region where RPA Manager runs, the bot can't receive new tasks until connectivity is reestablished.
