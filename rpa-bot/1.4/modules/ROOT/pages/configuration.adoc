...
This panel displays a list of important registry settings for secure sessions, which can be fixed directly from the panel.

To fix a setting, click the Fix it icon. A confirmation pop-up displays to indicate the setting was fixed successfully.
