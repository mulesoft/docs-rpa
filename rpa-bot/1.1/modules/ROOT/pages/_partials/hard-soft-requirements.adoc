...
* If you want to run more than one secure session in parallel on a bot, make sure that a terminal server software is installed on the computer of the bot.
