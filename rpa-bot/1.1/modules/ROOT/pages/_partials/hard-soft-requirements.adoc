...
To communicate with RPA Manager, RPA Bot requires you to enter one of the following Internet routes in the *RPA Manager to connect* field on the RPA Bot Configurator pop-up:
