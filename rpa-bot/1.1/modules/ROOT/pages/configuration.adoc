...
+
[IMPORTANT]
Ensure that the local _Username_ does not conflict with the _Username_ of the remote user used to login to the machine.
...
To test your connection settings for the Secure Session, click *TEST SETTINGS*. In the *TEST SETTINGS* dialog, enter test parameters for the Secure Session.
